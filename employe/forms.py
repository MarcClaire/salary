...
class EmployeForm(forms.ModelForm):
    ...
    photo_cnib = forms.ImageField(label="Ajouter la photo de votre CNIB",required=False ,
        widget=forms.ClearableFileInput(
        attrs={'class': 'form-control-file'}))
    photo_identite = forms.ImageField(label="Ajouter votre photo d'identité",required=False ,
        widget=forms.ClearableFileInput(
        attrs={'class': 'form-control-file'}))
